    ...
    return (
        <div className='homeLayout'>
            ...
            <div className='homeContent'>
                ...
                <h3 style={{textAlign:'center'}}>The Kid's Table helps you quickly find tasty, nutritious</h3>
                <h3 style={{textAlign:'center'}}> kid-approved meals that match your and your child's needs</h3>
            </div>
